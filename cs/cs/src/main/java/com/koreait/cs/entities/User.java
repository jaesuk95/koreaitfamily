...
public class User{
    ...
    public User(String email, String name, String password, String bio, String instagram, String twitter, String nationality, String facebook,
                String telegram, String ig_tag, String tw_tag, String fb_tag, String tg_tag, Long user_id, String profilePicture, boolean enabled,
...
//        this.email_duplicate = email_duplicate;
//        this.password_duplicate = password_duplicate;
    }
